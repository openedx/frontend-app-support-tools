  ...
  return (
    <div id="entitlementsAndEnrollmentsContainer">
      <div className="mb-2 p-2 background-light-gray">
        <From.Control name="courseId" className="mr-1 col-sm-4" placeholder="Course ID or Name" defaultValue={searchValue} onChange={(e) => { setSearchValue(e.target.value.toLowerCase()); }} />
      </div>
      <Entitlements
        user={user}
