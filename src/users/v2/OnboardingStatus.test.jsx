...
import v2OnboardingStatusData from '../data/test/onboardingStatus';
...
describe('Onboarding Status', () => {
  ...
  beforeEach(async () => {
    jest.spyOn(api, 'getV2OnboardingStatus').mockImplementationOnce(() => Promise.resolve(v2OnboardingStatusData));
  ...
  it('Onboarding Status', () => {
    ...
    expect(verifiedInDataBody.at(0).text()).toEqual(v2OnboardingStatusData.verifiedIn.courseId);
    expect(verifiedInDataBody.at(1).text()).toEqual(titleCase(v2OnboardingStatusData.verifiedIn.onboardingStatus));
    expect(verifiedInDataBody.at(2).text()).toEqual(formatDate(v2OnboardingStatusData.verifiedIn.expirationDate));
    ...
    expect(currentStatusDataBody.at(0).text()).toEqual(v2OnboardingStatusData.currentStatus.courseId);
    expect(currentStatusDataBody.at(1).text()).toEqual(
      titleCase(v2OnboardingStatusData.currentStatus.onboardingStatus),
    );
    expect(currentStatusDataBody.at(2).text()).toEqual(formatDate(v2OnboardingStatusData.currentStatus.expirationDate));
  ...
  it('No Onboarding Status Data with current status data only', async () => {
    const onboardingData = { ...v2OnboardingStatusData, verifiedIn: null };
  ...
  it('Onboarding Status Data with null values', async () => {
    ...
    const onboardingData = { ...v2OnboardingStatusData, verifiedIn: nullData };
